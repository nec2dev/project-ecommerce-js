            ...
            <div class="container py-2">
                ...
                <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                        <a href="./pages/login.html" class="btn btn-outline-dark btn-sm me-2">Login</a>
                        <a href="./pages/sign_up.html" class="btn btn-outline-dark btn-sm me-2">Sign up</a>
                        <a href="./pages/user.html" class="d-flex align-items-center">
                    ...
                    <div class="container-fluid px-0">
                        ...
                        <div class="collapse navbar-collapse" id="mainNavbar">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item"><a class="nav-link px-2" href="./pages/categories.html">Categories</a>
                                </li>
                                <li class="nav-item"><a class="nav-link px-2" href="./pages/shop.html">Shop</a></li>
                                <li class="nav-item"><a class="nav-link px-2" href="./pages/contacts.html">Contacts</a></li>
                                <li class="nav-item"><a class="nav-link px-2" href="./pages/faqs.html">FAQs</a></li>
                            </ul>
                            <div class="d-flex ms-md-auto mt-3 mt-md-0">
                                <a href="./pages/bills.html" class="me-3">
                                    <img src="./assets/img/icons/receipt.svg" alt="Bills" style="height:22px;">
                                </a>
                                <a href="./pages/wishlist.html" class="me-3">
